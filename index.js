...
#rm_print_characters_block .character_select .avatar{ position:absolute; inset:0; width:100%; height:100%; border-radius:inherit;
  overflow:hidden; align-self:auto; box-shadow:0 -6px 16px rgba(0,0,0,.45), 0 0 0 1px var(--SmartThemeBorderColor, rgba(255,255,255,.12)); }
#rm_print_characters_block .character_select .avatar img{ width:100%; height:100%; object-fit:cover; border:0; border-radius:0; box-shadow:none; }
#rm_print_characters_block .character_select .character_select_container{ position:absolute; inset:0; z-index:2; width:auto; padding:10px 14px;
  ...
  background:linear-gradient(to right, rgba(0,0,0,.78) 30%, rgba(0,0,0,.35) 62%, transparent 100%); }
#rm_print_characters_block .character_select .character_name_block{ margin:0; }
#rm_print_characters_block .character_select .ch_name{ font-size:var(--pv-name,15.5px); color:#fff; text-shadow:0 1px 6px rgba(0,0,0,.8); }
#rm_print_characters_block .character_select .ch_description{ margin:0; color:rgba(255,255,255,.72); }
#rm_print_characters_block .character_select.is_fav .ch_name{ color:var(--golden); }
#rm_print_characters_block .character_select.is_fav .avatar{ outline:none; box-shadow:0 -6px 16px rgba(0,0,0,.45), 0 0 0 2px var(--golden); }
    ` },
